...
export function HomeScreen() {
  ...
  const [transactions] = useState<Transaction[]>([
    { id: '1', title: 'Salário Mensal', value: 2500, type: 'income', date: new Date() },
    { id: '2', title: 'Supermercado Continente', value: 85.40, type: 'expense', date: new Date() },
    { id: '3', title: 'Ginásio', value: 35.00, type: 'expense', date: new Date() },
    { id: '4', title: 'Freelance React', value: 450, type: 'income', date: new Date() },
  ]);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.balanceCard}>
        ...
        <Text style={styles.balanceValue}>
          {new Intl.NumberFormat('pt-PT', { style: 'currency', currency: 'EUR' }).format(totals.total)}
        </Text>
